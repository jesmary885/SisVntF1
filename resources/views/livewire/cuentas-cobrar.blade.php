<div>
    <div class="card">
        <h1 class="py-0 text-lg text-gray-500 ml-4 mt-1"> <i class="fas fa-lock"></i> Cuentas por cobrar</h1>
    </div>
                    ...
                    <table class="table table-striped table-responsive-lg table-responsive-md table-responsive-sm">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th class="text-center">Monto en deuda</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($cuentas as $cuenta)
                                <tr>
                                    ...
                                    <td class="text-center">{{$cuenta->cliente->nombre}} {{$cuenta->cliente->apellido}}</td>
                                    <td class="text-center">{{$cuenta->cliente->nro_documento}}</td>
                                    <td class="text-center">{{ $moneda_simbolo }} {{ round(($cuenta->deuda_cliente/ $tasa_dia),2)}}</td>
                                </tr>
                            @endforeach
                            <tr>
