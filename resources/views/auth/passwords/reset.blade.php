      ...
      <div id="login">
        ...
        @csrf
          ...
          <fieldset class="clearfix">
            ...
            <p><span class="fontawesome-lock"></span><input name="password" id="password" type="password" name="password" placeholder="Contraseña" onBlur="if(this.value == '') this.value = 'Contraseña'" onFocus="if(this.value == 'Contraseña') this.value = ''" required></p> 
            <x-input-error class="error" for="password" />
            <p><span class="fontawesome-lock"></span><input name="password_confirmation" id="password-confirm" type="password" name="password"  placeholder="Repetir contraseña" onBlur="if(this.value == '') this.value = 'Contraseña'" onFocus="if(this.value == 'Contraseña') this.value = ''" required></p> 
            <x-input-error class="error" for="password" />
