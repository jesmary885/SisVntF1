...
Route::middleware(['auth'])->group(function()
{
  ...
  //  Route::get('reporte_desactivados',[ReportesController::class,'index_desactivados'])->name('reportes.index.desactivados')->middleware('permission:productos');
   
    //reporte movimientos en caja
  /*  Route::get('reporte_caja',[ReportesController::class,'index_caja'])->name('reportes.index.caja')->middleware('permission:productos');
    Route::get('reportes_caja/{sucursal_id}/{fecha_inicio}/{fecha_fin}',[ReportesController::class,'cajas'])->name('cajas.reportes')->middleware('permission:productos');*/
    ...
    //reporte x y z
    Route::get('reporte_x',[ReportesSeniatController::class,'reportex'])->name('reporte.x')->middleware('permission:reportes.reportes_seniat');
    Route::get('reportes_z',[ReportesSeniatController::class,'reportez'])->name('reporte.z')->middleware('permission:reportes.reportes_seniat');
